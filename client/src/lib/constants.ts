  ...
  },
  {
    ...
    dropdownItems: [
      ...
      },
      {
        ...
        items: [
          { name: "Core Development", href: "/web-development", hasSubmenu: true },
          { name: "Business Solutions", href: "/web-development", hasSubmenu: true },
          { name: "Modern Web Experiences", href: "/web-development", hasSubmenu: true },
          { name: "Advanced & Emerging", href: "/web-development", hasSubmenu: true },
        ],
        submenuItems: {
          "Core Development": [
          ...
          "Business Solutions": [
            { name: "CMS Development (WordPress, Drupal, Joomla)", href: "/web-development" },
            { name: "eCommerce Development (Shopify, Magento, WooCommerce)", href: "/web-development" },
            { name: "Custom Web Applications (SaaS platforms, enterprise apps)", href: "/web-development" },
            { name: "ERP/CRM Integrations (SAP, Salesforce, NetSuite integration)", href: "/web-development" },
          ],
          "Modern Web Experiences": [
            { name: "Responsive Web Design (mobile-first, cross-browser compatibility)", href: "/web-development" },
            { name: "Progressive Web Apps (PWA) (offline-ready, app-like experiences)", href: "/web-development" },
            { name: "Single Page Applications (SPA) (React, Angular, Vue)", href: "/web-development" },
            { name: "Headless Development (headless CMS & commerce via APIs)", href: "/web-development" },
          ],
          "Advanced & Emerging": [
            { name: "API & Microservices Development (REST, GraphQL, cloud-native)", href: "/web-development" },
            { name: "Cloud-Native Web Development (AWS, Azure, GCP web apps)", href: "/web-development" },
            { name: "AI-Powered Web Applications (chatbots, Gen AI integration, personalization engines)", href: "/web-development" },
            { name: "IoT-Enabled Web Apps (real-time dashboards, device data portals)", href: "/web-development" },
            { name: "Blockchain & Web3 Development (dApps, smart contracts, NFT platforms)", href: "/web-development" },
            { name: "AR/VR Web Development (immersive, 3D, metaverse-ready apps)", href: "/web-development" },
          ],
        },
      },
      {
