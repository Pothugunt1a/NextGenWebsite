...
const serviceAreaData = [
  {
    ...
    image: "/assets/CloudAI.png",
    content:
      "At RT NextGen AI, we specialize in delivering comprehensive IT consultation services that empower businesses to succeed in the cloud-first era. Our expertise spans across cloud implementation, legacy application modernization, and custom cloud application development.",
    features: [
  ...
  },
  {
    ...
    image: "/assets/BigData.png",
    content:
      "Catch the Big Data wave with RT NextGen AI. Our IT Consulting Services help enterprises uncover new business opportunities and gain competitive advantage through data-driven strategies.",
    features: [
    ...
    additionalInfo:
      "With our proven Discover, Design, Develop, and Deploy methodology, RT NextGen AI has the expertise and tools to bring your data strategy to life—turning complex information into business intelligence that drives growth.",
  },
  {
    id: "consulting-solutions",
    name: "Consulting Solutions",
    image: "/assets/ConsultingSolutions.png",
    content:
      "At RT NextGen AI, we help organizations unlock the power of AI-driven innovation across the entire customer lifecycle. Our consulting solutions combine predictive analytics, natural language processing, and cognitive engines—backed by human expertise.",
    features: [
    ...
    additionalInfo:
      "For large enterprises managing billions of customer interactions annually, the ability to anticipate and address customer needs before they arise delivers transformative benefits. These capabilities enable businesses to evolve from reactive to predictive.",
  },
  {
    id: "application-development",
    name: "Application Development & Support",
    image: "/assets/ApplicationDevelopment.png",
    content:
      "At RT NextGen AI, we bring cutting-edge capabilities to the development of large-scale, multi-million-dollar enterprise applications. Our success in executing numerous fixed-price, fixed-outcome projects has enabled us to build a robust Application Development & Support practice.",
    features: [
    ...
    additionalInfo:
      "Our integrated testing framework includes test design, automation toolkits, execution strategies, and comprehensive metrics reporting. This ensures faster delivery cycles and higher software quality at reduced costs.",
  },
];
    ...
    >
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-left">
          ...
          >
            ...
            >
              Our Salesforce.com consultants bring depth and breadth of
              expertise across varied industries to function as trusted partners
              for our customers. We provide effective planning and execution in
              the delivery of Salesforce.com solutions and leverage the platform
              to help maximize return on investment. By combining our
              best-in-class agile preparation methodologies with deep market
              experience, we enable our clients to meet their most advanced
      ...
      <section className="relative py-16 text-white overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[#0a0e27] via-[#1a1f3a] to-[#0f1419]">
          ...
          <div className="absolute bottom-20 left-20 w-96 h-96 bg-cyan-500/10 rounded-full blur-3xl animate-float-slower"></div>
        </div>
                    ...
                    {selectedServiceArea.features && (
                      <div className="space-y-4">
                        <h4 className="text-xl font-semibold text-white mb-4">
                          {selectedServiceArea.id === "cloud-ai-consultation"
                            ? "Our Core Services Include:"
                            : selectedServiceArea.id === "big-data-intelligence"
                              ? "Our Methodology:"
                        ...
                        <div className="grid gap-3">
                          {selectedServiceArea.features.map(
                            (feature, index) => (
                              <motion.div
                                key={index}
      ...
      <section className="relative py-16 overflow-hidden">
        {/* Animated Background */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#0a0e27] via-[#1a1f3a] to-[#0f1419]">
          <div className="absolute top-10 left-10 w-64 h-64 bg-purple-500/10 rounded-full blur-3xl animate-float-slow"></div>
          <div className="absolute bottom-10 right-10 w-80 h-80 bg-blue-500/10 rounded-full blur-3xl animate-float"></div>
        </div>
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-300 max-w-4xl mx-auto">
                Predictive solutions utilize client profile information for
                insights into organizations' requirements and preferences from
                previous interactions across all channels to see intent and
                choose the best agent or resource to service their needs.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border border-blue-500/20 rounded-xl p-8">
                ...
                <p className="text-gray-300 mb-6">
                  ...
                  Our AI solutions are always complemented by human assistance,
                  ensuring accurate, ethical, and intelligent outcomes.
                </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              With our focus on training and certification, you can be certain
              that AI Technologies, LLC employs only the most qualified
              Salesforce.com-certified professionals with extensive expertise in
              Force.com business cloud application development.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 rounded-xl p-8">
              ...
              <p className="text-gray-400">
                We combine best-in-class agile methodologies with deep industry
                insight, allowing us to adapt quickly to your evolving business
                and technology challenges. With our stress on training and
                certification, you can be certain that AI Technologies, LLC
                employs only the most qualified professionals with extensive
                expertise.
              </p>
            </div>
          </motion.div>
