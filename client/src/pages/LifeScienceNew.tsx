...
const services = [
  ...
  },
  {
    ...
    backgroundImage:
      "https://images.unsplash.com/photo-1576671081837-49000212a370?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80",
  },
  {
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-8xl mx-auto relative">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              {/* Second Row - Central Layout with Pharmacovigilance in Middle */}
              <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 items-center">
                {/* Left Spacer */}
                <div></div>

                {/* Central Pharmacovigilance / Drug Safety Card */}
                <motion.div
                ...
                >
                  <div className="flex flex-col gap-6 p-6 bg-gray-800/60 backdrop-blur-sm border border-gray-700 rounded-2xl hover:border-blue-500/50 hover:bg-gray-800/80 transition-all duration-500 group-hover:translate-y-2 h-full">
                    ...
                    <div className="flex-grow text-center">
                      ...
                      <h4 className="text-lg font-bold text-white mb-3 group-hover:bg-gradient-to-r group-hover:from-blue-500 group-hover:to-cyan-500 group-hover:bg-clip-text group-hover:text-transparent transition-all duration-300">
                        {services[2].title}
                      </h4>
                      <p className="text-gray-400 text-sm leading-relaxed">
              ...
              {/* Third Row - Regulatory Affairs and Quality and Compliance */}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              ...
              and bring life-changing treatments to market faster with our
              comprehensive life science solutions.
            </motion.p>
