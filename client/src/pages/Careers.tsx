        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <motion.div
              ...
              className="text-3xl font-bold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-8"
            >
              careers@rtnextgenai.com
            </motion.div>
            ...
            <motion.p
              ...
              className="text-lg text-white/70 leading-relaxed max-w-3xl mx-auto mb-12"
            >
            ...
            >
              <Button
                size="lg"
                className="group bg-gradient-to-r from-cyan-500 via-blue-500 to-blue-600 hover:from-cyan-400 hover:via-blue-400 hover:to-blue-500 px-12 py-6 text-xl font-bold shadow-2xl hover:shadow-cyan-500/25 transition-all duration-300 border-0 rounded-2xl text-white"
                onClick={redirectToContact}
              >
