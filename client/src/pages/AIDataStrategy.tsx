          ...
          >
            ...
            <div className="space-y-6">
              <p className="text-lg text-gray-300 leading-relaxed">
                ...
                Our mission is to empower your business through expert
                consulting in Big Data, Data Science, AI, and Machine Learning.
              </p>
              <p className="text-lg text-gray-300 leading-relaxed">
                Our AI consultants follow industry best practices, assess and
                optimize your current data science initiatives, work closely
