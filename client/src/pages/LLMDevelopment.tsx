...
const processSteps = [
  ...
  },
  {
    ...
    icon: <img src={chatbotConsultationIcon} alt="Automated Content Generation" className="h-8 w-8" />,
    color: "from-blue-500 to-cyan-500",
  },
  {
    number: "4.",
  ...
  },
  {
    ...
    icon: <img src={multiLanguageSupportIcon} alt="Real-Time Translation and Localization" className="h-8 w-8" />,
    color: "from-blue-500 to-cyan-500",
  },
];
