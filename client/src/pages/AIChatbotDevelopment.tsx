              ...
              <div className="w-80 h-80 rounded-full flex items-center justify-center shadow-2xl overflow-hidden relative">
                ...
                <div className="absolute inset-0 pointer-events-none">
                  ...
                  >
                    ...
                    <path
                      d="M 80 32 A 128 128 0 0 1 80 288"
                      stroke="#64748b"
                      strokeWidth="3"
                      fill="none"
                      opacity="0.9"
                    ...
                    <g>
                      ...
                      <circle cx="80" cy="48" r="4" fill="#6366f1" opacity="0.9" />
                      <line x1="80" y1="48" x2="120" y2="48" stroke="#64748b" strokeWidth="2" strokeDasharray="3,3" opacity="0.7" />
                      
                      {/* Dot 2 - connects to advantage 2 */}
                      <circle cx="80" cy="96" r="4" fill="#6366f1" opacity="0.9" />
                      <line x1="80" y1="96" x2="120" y2="96" stroke="#64748b" strokeWidth="2" strokeDasharray="3,3" opacity="0.7" />
                      
                      {/* Dot 3 - connects to advantage 3 */}
                      <circle cx="80" cy="160" r="4" fill="#6366f1" opacity="0.9" />
                      <line x1="80" y1="160" x2="120" y2="160" stroke="#64748b" strokeWidth="2" strokeDasharray="3,3" opacity="0.7" />
                      
                      {/* Dot 4 - connects to advantage 4 */}
                      <circle cx="80" cy="224" r="4" fill="#6366f1" opacity="0.9" />
                      <line x1="80" y1="224" x2="120" y2="224" stroke="#64748b" strokeWidth="2" strokeDasharray="3,3" opacity="0.7" />
                    </g>
                  </svg>
                </div>
