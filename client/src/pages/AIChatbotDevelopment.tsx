The code changes are applied to update the styling of the Why Choose RT NextGenAI card components to match the Core Values styling by modifying the border and shadow properties.
```
