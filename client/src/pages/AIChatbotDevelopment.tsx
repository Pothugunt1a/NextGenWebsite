        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-left">
            ...
            >
              ...
              >
                Leverage the power of AI chatbots to improve customer
                satisfaction and take your business to new heights with
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Comprehensive AI chatbot development solutions designed to
                enhance customer engagement and streamline business operations
              </p>
            </motion.div>
