...
const whyChooseUsItems = [
  {
    ...
    description:
      "Our team masters modern frameworks like React, Vue.js, Angular, Node.js, and Python Django for comprehensive web development solutions.",
    color: "from-blue-500 to-cyan-500",
  },
  {
    ...
    description:
      "Mobile-first responsive designs with modern UI/UX principles, ensuring seamless experiences across all devices and screen sizes.",
    color: "from-green-500 to-emerald-500",
  },
  {
    ...
    description:
      "Lightning-fast websites with advanced optimization techniques, SEO best practices, and superior Core Web Vitals scores.",
    color: "from-purple-500 to-violet-500",
  },
  {
    ...
    description:
      "Enterprise-grade security measures with scalable architecture that grows with your business needs and handles high traffic volumes.",
    color: "from-orange-500 to-red-500",
  },
];
...
const faqs: FAQ[] = [
  {
    ...
    answer:
      "We specialize in modern web technologies including React, Vue.js, Angular, Node.js, Python Django, PHP Laravel, and various databases. Our full-stack expertise covers both frontend and backend development.",
  },
  {
    question: "How long does web development typically take?",
    answer:
      "Timeline varies based on project complexity. Simple websites take 2-4 weeks, business websites take 6-8 weeks, and complex web applications can take 3-6 months. We provide detailed timelines during project planning.",
  },
  {
    question: "Do you provide ongoing maintenance and support?",
    answer:
      "Yes, we offer comprehensive maintenance packages including security updates, performance monitoring, content updates, bug fixes, and feature enhancements to keep your website current and secure.",
  },
  {
    question: "Can you help with e-commerce website development?",
    answer:
      "Absolutely! We develop custom e-commerce solutions with payment gateways, inventory management, order processing, and integrate with platforms like Shopify, WooCommerce, and custom solutions.",
  },
  {
    question: "Do you optimize websites for search engines?",
    answer:
      "Yes, all our websites are built with SEO best practices including optimized code structure, meta tags, schema markup, fast loading times, and mobile responsiveness to improve search engine rankings.",
  },
];
...
const webOfferings = [
  {
    ...
    description:
      "Modern responsive interfaces using React, Vue.js, Angular with cutting-edge UI/UX design principles and optimal user experience.",
    features: [
  ...
  },
  {
    ...
    description:
      "Robust server-side solutions with Node.js, Python Django, PHP Laravel, and comprehensive API development for scalable applications.",
    features: [
  ...
  },
  {
    ...
    description:
      "Complete web applications with integrated frontend and backend, database management, and seamless user experiences.",
    features: [
  ...
  },
  {
    ...
    description:
      "Custom e-commerce platforms with payment gateways, inventory management, order processing, and conversion optimization.",
    features: [
  ...
  },
  {
    ...
    description:
      "Modern web applications with native app-like experiences, offline functionality, and push notifications.",
    features: [
      "PWA development",
  ...
  },
  {
    ...
    description:
      "Comprehensive website maintenance including updates, security patches, performance monitoring, and technical support.",
    features: [
...
const industryData = [
  {
    ...
    content:
      "Custom e-commerce solutions with advanced features like product catalogs, secure payment processing, inventory management, order tracking, and personalized shopping experiences that drive sales and customer loyalty.",
  },
  {
    id: "healthcare",
    name: "Healthcare",
    ...
    content:
      "HIPAA-compliant healthcare websites and patient portals with appointment scheduling, telemedicine integration, patient records management, and secure communication systems for improved patient care.",
  },
  {
    id: "finance",
    ...
    content:
      "Secure financial websites with advanced encryption, compliance features, customer portals, transaction processing, and regulatory compliance for banks, fintech, and financial institutions.",
  },
  {
    id: "education",
    name: "Education",
    ...
    content:
      "Educational platforms with learning management systems, online course delivery, student portals, assessment tools, and interactive learning experiences for schools and training organizations.",
  },
  {
    id: "corporate",
    name: "Corporate",
    ...
    content:
      "Professional corporate websites with content management systems, employee portals, client dashboards, document management, and business process automation for enhanced productivity.",
  },
  {
    id: "media",
    ...
    content:
      "Dynamic media websites with content streaming, social integration, user-generated content, subscription management, and multimedia experiences for entertainment and media companies.",
  },
];
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-left">
          ...
          >
            ...
            >
              <span className="bg-gradient-to-r from-white via-blue-100 to-[#61DAFB] bg-clip-text text-transparent">
            ...
            >
              Create powerful web experiences that captivate users and drive
              business growth. From responsive websites to complex web
              applications, we deliver cutting-edge solutions.
            </motion.p>
            ...
            <div className="mb-32">
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-[#61DAFB]/20 border border-[#61DAFB]/30 rounded-full backdrop-blur-sm"
              >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive web development solutions from frontend to
          ...
          <div className="max-w-8xl mx-auto relative">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              {webOfferings.slice(0, 2).map((offering, index) => (
                <motion.div
                  key={index}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-8">
                    <div className="mb-4">
                      ...
                      <p className="text-blue-100 leading-relaxed mb-6">
                        Cutting-edge web applications that deliver exceptional
              ...
              <div className="flex flex-col gap-6">
                {webOfferings.slice(2, 4).map((offering, index) => (
                  <motion.div
                    key={index + 2}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {webOfferings.slice(4).map((offering, index) => (
                <motion.div
                  key={index + 4}
                  initial={{ opacity: 0, x: index === 0 ? -100 : 100 }}
                  whileInView={{ opacity: 1, x: 0 }}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Why Choose NextGenAI for Web Development?
            </h2>
            <div className="w-32 h-1 bg-gradient-to-r from-blue-500 to-cyan-500 mx-auto mb-8"></div>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Expert web development with modern technologies and proven
              methodologies for exceptional digital experiences.
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="text-white font-medium">
                Leading Web Development Partner
              </span>
              <Award className="h-4 w-4 text-blue-400 fill-current" />
            </motion.div>
            ...
            >
              ...
              <br />
              <span className="text-white">Web Presence?</span>
            </motion.h2>
            ...
            >
              ...
              Let's create exceptional web experiences that drive results.
            </motion.p>
